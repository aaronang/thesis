...
\begin{figure}
\begin{center}
\subfloat[No Test Diversity.][\centering No Test Diversity.\par $\rho' = 1.0 \quad
\mathcal{G}=0.0$]{
\label{fig:no_diversity}
...
\subfloat[Test Diversity.][\centering Test Diversity.\par $\rho'=1.0 \quad \mathcal{G}=1.0$]{
\label{fig:diversity}
\def\arraystretch{0.95}
\begin{tabular}{c|cccc}
  & $c_1$ & $c_2$ & $c_3$ & $c_4$     \\ \hline
...
\begin{figure}[htb]
\begin{center}
\subfloat[Component Ambiguity.][\centering Component Ambiguity.\par $\rho' = 1.0 \quad
\mathcal{G}=1.0$ \par $\mathcal{U}=0.75$]{
\label{fig:ambiguity}
\def\arraystretch{0.95}
\begin{tabular}{c|cccc}
  & $c_1$ & $c_2$ & $c_3$ & $c_4$     \\ \hline
...
\subfloat[No Component Ambiguity.][\centering No Component Ambiguity.\par $\rho'=1.0 \quad
\mathcal{G}=1.0$ \par $\mathcal{U}=1.0$]{
